...
public class QChatUtils {
    ...
    private String TITLE_FIND_RED_PACKAGE, TITLE_CAN_OPEN, TITLE_OPENED, TITLE_ALREADY_OPENED,
            TITLE_COMMAND_RED_PACKAGE, TITLE_CLICK_INPUT_COMMAND, TITLE_SEND_BUTTON, TITLE_OPENED_ALL;
    ...
    public QChatUtils(Context context) {
        ...
        TITLE_COMMAND_RED_PACKAGE = mContext.getResources().getString(R.string.title_qchat_command_red_package);
        TITLE_CLICK_INPUT_COMMAND = mContext.getResources().getString(R.string.title_qchat_click_input_command);
        TITLE_SEND_BUTTON = mContext.getResources().getString(R.string.title_qchat_send_button);
        TITLE_OPENED_ALL = mContext.getResources().getString(R.string.title_qchat_opened_all);
        mCanOpen = false;
    }
    ...
    private void getAllNode(AccessibilityNodeInfo parentNode, String str) {
        ...
        for (int i = 0; i < parentNode.getChildCount(); i++) {
            ...
            if (text != null) {
                ...
                if (text.toString().contains(TITLE_COMMAND_RED_PACKAGE) && text.toString().contains(TITLE_OPENED_ALL)) {// 已被领
                ...
                if (text.toString().equals(TITLE_SEND_BUTTON)
                        && childNode.getClassName().toString().equals("android.widget.Button")) {// 发送按钮
